...
```{r data}
fast.food.data <- read.table('fast_food_revenues.csv', header = T, sep = ',')
fast.food.data
```
...
[^1] Die Inhalte dieser Übung basieren auf dem Kapitel 16 aus "_Pace L._ Beginning R: An Introduction in Statistical Programming. Apress: 2012"